...
| [node/main.mjs](node/main.mjs) | Build `bindings/node`, set `EXIMIETAS_LOGGER_LIB`, run `node examples/node/main.mjs` |
| [dotnet/](dotnet/) | `dotnet run --project examples/dotnet` with `EXIMIETAS_LOGGER_LIB` set |
